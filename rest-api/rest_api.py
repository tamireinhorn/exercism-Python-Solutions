...
class RestAPI:
    ...
    def parse_database_return(self, user: str) -> dict: 
        ...
        copy_user_entry = deepcopy(self.database.get(user))
    ...
    def __modify_user(self, user: str, other_guy: str, amount: float) -> dict:
        ...
        user_data['owes'][other_guy] = current_debt + amount # We update the dictionary, adding the amount to the current debt.
